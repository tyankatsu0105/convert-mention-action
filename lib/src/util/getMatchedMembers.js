 ...
 * @param text
 */
exports.getMatchedMembers = (members, users, text) => members.filter((member) => getMatchedSlackMentions(getGitHubMentionsByArgs(text), users).includes(member['profile']['real_name']));
// /**
